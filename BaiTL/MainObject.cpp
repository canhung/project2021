...
{
    //su dung ham loadimg cua baseobject
    bool ret= BaseObject::LoadImg(path,screen);
    if (ret== true)
    {   // lay cr va cd cua 1 frame
...
void MainObject:: Show(SDL_Renderer* des)
{
    ...
    // xem chinh xac nhan vat dang o toa do nao
...
void MainObject:: HandlInputAction(SDL_Event events, SDL_Renderer* screen)
{
...
void MainObject::CheckToMap(Map& map_data)
{
    ...
    //tinh xem nhan vat o vi tri o thu bnh
    ...
    if(y_pos_>map_data.max_y_)//khi roi xuong vuc y_pos_ tang lien tuc vuot qua map data max y
    {
        come_back_time_=60;
    }
}
void MainObject:: DoPlayer(Map& map_data)
{
    ...
    {   if(on_ground_==true)
        {
            y_val_=-PLAYER_JUMP_VAL;   //chi khi nhan vat dung tren mat dat thi moi nhay
        }
...
{   //di chuyen dc 1/3 man hinh map se di theo
